...
# Эндпоинт: Получение списка категорий продуктов

Этот эндпоинт предоставляет список категорий продуктов.


**Метод:** `GET`

**Конечная ссылка:** `https://api.govcarpets.ru/api/v1/categories`
...
- **categories**: Массив объектов с информацией о категориях продуктов.
